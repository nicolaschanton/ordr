...
from .serializers import CustomerLoyaltyCardSerializer, CustomerLoyaltyCardHistorySerializer

from .models import CustomerLoyaltyCard, CustomerLoyaltyCardHistory


class CustomerLoyaltyCardViewSet(viewsets.ModelViewSet):
    ...
    def get_serializer_class(self):
        if self.action in ['list', 'retrieve', 'partial_update', 'update', 'delete']:
            serializer = CustomerLoyaltyCardSerializer
...
class CustomerLoyaltyCardHistoryViewSet(viewsets.ModelViewSet):
    queryset = CustomerLoyaltyCardHistory.objects.all()
    ...
    def get_serializer_class(self):
        if self.action in ['list', 'retrieve', 'partial_update', 'update', 'delete']:
            serializer = CustomerLoyaltyCardHistorySerializer
